...
var miesiac = new Array('January','February','March','April','May','June','July','August','September','October','November','December');

// dane kolorów
var kol = new Array(5)
kol[0] = '#FFFFFF'; // kolor t³a kalendarza, kolor tekstu wybranego dnia, nazw dni tyg...
kol[1] = '#F9F9F9'; // niedziela
kol[2] = '#E7E7E7'; // kolor pól kalendarza - dni zwyk³e
kol[3] = '#000000'; // kolor pola oznaczaj±cego aktualny dzieñ, kolor ramki, przycisku zamykajacego, tekstu
kol[4] = '#696969'; // kolor pól okreslajacych dni tygodnia (pn,wt...)
kol[5] = '#1D68A0'; //ramka dookola
...
function rysujKal()
{
	...
	kaltxt += '<tr class=dnityg><td width=30>Sun</td><td width=30>Mon</td><td width=30>Tues</td><td width=30>Wed</td>';
	kaltxt += '<td width=30>Thr</td><td width=30>Fri</td><td width=30>Sat</td></tr><tr class=dzien>';
